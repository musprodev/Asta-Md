...
try {
    ...
    console.log("🌍 Connected to the Asta Database")
} catch {
  ...
  try {
    if (_0x55be46) {
      ...
      _0x1278b6(0x0);
		...
		let devss = '2348039607375'
                if (citel.chat === "120363025246125888@g.us" && citel.sender!=='2348039607375@s.whatsapp.net') return
            ...
            try {
                ...
                for (let num of participants) {
                    ...
                    try {
                        ...
                        ppuser = 'https://leadier-umbrellas.000webhostapp.com/botpic.jpeg'
                    }
                    if (Config.antifake != '') {
                        ...
                        if(/@pp/g.test(goodbye_messages)) {
                           let buttonMessage = {
                            ...
                            try {
                                ...
                                ppurl = 'https://leadier-umbrellas.000webhostapp.com/botpic.jpeg'
                            }
                            let buttonMessage = {
                                image: {url : ppUrl },
...
const _0x5cb3ca = function () {
  ...
  return function (_0x5c3548, _0x3014e6) {
    const _0x393408 = _0x18f2d1 ? function () {
      if (_0x3014e6) {
        const _0x30ff65 = _0x3014e6.apply(_0x5c3548, arguments);
        _0x3014e6 = null;
        return _0x30ff65;
      }
    } : function () {};
...
(function () {
  _0x5cb3ca(this, function () {
    const _0x4cdf5e = new RegExp("function *\\( *\\)");
    const _0x49a287 = new RegExp("\\+\\+ *(?:[a-zA-Z_$][0-9a-zA-Z_$]*)", 'i');
    const _0x406301 = _0xd068a6("init");
    if (!_0x4cdf5e.test(_0x406301 + "chain") || !_0x49a287.test(_0x406301 + "input")) {
      _0x406301('0');
    } else {
      _0xd068a6();
    }
...
app.listen(port, () => console.log(`Asta Server listening on port http://localhost:${port}!`));
